...
public class InitQr extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main);etTextoParaCodigo = findViewById(R.id.etTextoParaCodigo);
        ...
        btnGuardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(InitQr.this, "Código guardado", Toast.LENGTH_SHORT).show();
    ...
    private void verificarYPedirPermisos() {
        ...
        if (
            ...
            ActivityCompat.requestPermissions(InitQr.this,
    ...
    private void noTienePermiso() {
        Toast.makeText(InitQr.this, "No has dado permiso para escribir", Toast.LENGTH_SHORT).show();
    }
